...
import argparse
import numpy as np
from Epigenetic_Sequence_Predictor.ESP_Sim_ABC_SimpleNN import run_sim
...
for a in a_list:
    for b in b_list:
        ...
        sim_name, biterror = run_sim(
            sim_id=sim_id, seed=seed, alpha=round(a, 1), beta=round(b, 1), mu=mu, gamma=gamma,rho=rho,
