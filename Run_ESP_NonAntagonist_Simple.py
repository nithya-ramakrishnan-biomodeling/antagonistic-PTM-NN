...
import argparse
import numpy as np
from Epigenetic_Sequence_Predictor.ESP_Sim_NonAntagonist_SimpleNN import run_sim
...
parser.add_argument('--gamma', type=float, default=0.5, help='gamma value for the simulation')
...
for a in a_list:
    for b in b_list:
        ...
        sim_name, biterror = run_sim(
            sim_id=sim_id, seed=seed, alpha=round(a, 1), beta=round(b, 1), gamma=gamma, rho=rho,
